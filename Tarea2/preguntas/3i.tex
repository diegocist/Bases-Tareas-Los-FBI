...
\begin{figure}[H]
  ...
  \caption{Diagrama Entidad/Relación que representa los números racionales.}
\end{figure}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Un racional (reducido) puede tener múltiples racionales (simplificables), pero un racional (simplificable) puede tener un único racional (reducido)
  \end{itemize}
\end{itemize}
